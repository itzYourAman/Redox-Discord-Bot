...
class Server(commands.Cog):
  ...
  async def add_role(self, *, role: int, member: discord.Member):
    if member.guild.me.guild_permissions.manage_roles:
      ...
      await member.add_roles(role, reason="Redox | Role Added ")

  async def remove_role(self, *, role: int, member: discord.Member):
    if member.guild.me.guild_permissions.manage_roles:
      role = discord.Object(id=int(role))
      await member.remove_roles(role, reason="Redox | Role Removed")
  ...
  async def _owner(self, context: Context, member: discord.Member) -> None:
    if data := getConfig(context.guild.id):
      ...
      hacker = discord.Embed(
        description=
        f"<a:tickkk:1130730211382661171> | Successfully Given <@&{role}> To {member.mention}",
        color=0x00FFCA)
      ...
      hacker1 = discord.Embed(
        description=
        f"<a:crossss:1131829269509709875>  | Owner role is not setuped in {context.guild.name}",
        color=0x00FFCA)
  ...
  async def _coowner(self, context: Context, member: discord.Member) -> None:
    if data := getConfig(context.guild.id):
      ...
      hacker1 = discord.Embed(
        description=
        f"<a:crossss:1131829269509709875>  | Co Owner role is not setuped in {context.guild.name}",
        color=0x00FFCA)
      hacker1.set_author(name=f"{context.author}",
                         icon_url=f"{context.author.avatar}")
      hacker1.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def _headadmin(self, context: Context, member: discord.Member) -> None:
    if data := getConfig(context.guild.id):
      ...
      hacker1 = discord.Embed(
        description=
        f"<a:crossss:1131829269509709875>  | Head Admin role is not setuped in {context.guild.name}",
        color=0x00FFCA)
      hacker1.set_author(name=f"{context.author}",
                         icon_url=f"{context.author.avatar}")
      hacker1.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def _admin(self, context: Context, member: discord.Member) -> None:
    if data := getConfig(context.guild.id):
      ...
      hacker1 = discord.Embed(
        description=
        f"<a:crossss:1131829269509709875>  | Admin role is not setuped in {context.guild.name}",
        color=0x00FFCA)
      hacker1.set_author(name=f"{context.author}",
                         icon_url=f"{context.author.avatar}")
      hacker1.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def _girladmin(self, context: Context, member: discord.Member) -> None:
    if data := getConfig(context.guild.id):
      ...
      hacker1 = discord.Embed(
        description=
        f"<a:crossss:1131829269509709875>  | Girl Admin role is not setuped in {context.guild.name}",
        color=0x00FFCA)
      hacker1.set_author(name=f"{context.author}",
                         icon_url=f"{context.author.avatar}")
      hacker1.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def _headmod(self, context: Context, member: discord.Member) -> None:
    if data := getConfig(context.guild.id):
      ...
      hacker1 = discord.Embed(
        description=
        f"<a:crossss:1131829269509709875>  | Head Mod role is not setuped in {context.guild.name}",
        color=0x00FFCA)
      hacker1.set_author(name=f"{context.author}",
                         icon_url=f"{context.author.avatar}")
      hacker1.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def _mod(self, context: Context, member: discord.Member) -> None:
    if data := getConfig(context.guild.id):
      ...
      hacker1 = discord.Embed(
        description=
        f"<a:crossss:1131829269509709875> Mod role is not setuped in {context.guild.name}",
        color=0x00FFCA)
      hacker1.set_author(name=f"{context.author}",
                         icon_url=f"{context.author.avatar}")
      hacker1.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def _girlmod(self, context: Context, member: discord.Member) -> None:
    if data := getConfig(context.guild.id):
      ...
      hacker1 = discord.Embed(
        description=
        f"<a:crossss:1131829269509709875>   | Girl Mod role is not setuped in {context.guild.name}",
        color=0x00FFCA)
      hacker1.set_author(name=f"{context.author}",
                         icon_url=f"{context.author.avatar}")
      hacker1.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def staff(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<a:tickkk:1130730211382661171> | Successfully Setuped `Staff` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def girl(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<a:tickkk:1130730211382661171> | Successfully Setuped `girl` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def vip(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<a:tickkk:1130730211382661171> | Successfully Setuped `vip` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def guest(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<a:tickkk:1130730211382661171> | Successfully Setuped `guest` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def friend(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<a:tickkk:1130730211382661171> | Successfully Setuped `friend` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def owner(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<a:tickkk:1130730211382661171> | Successfully Setuped `Owner` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def coowner(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<a:tickkk:1130730211382661171> | Successfully Setuped `Co Owner` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def headadmin(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<a:tickkk:1130730211382661171> | Successfully Setuped `Head Admin` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def admin(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<a:tickkk:1130730211382661171> | Successfully Setuped `Admin` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def headmod(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<a:tickkk:1130730211382661171> | Successfully Setuped `Head Mod` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def mod(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<a:tickkk:1130730211382661171> | Successfully Setuped `Mod` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def girladmin(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<a:tickkk:1130730211382661171> | Successfully Setuped `Girl Admin` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def girlmod(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<a:tickkk:1130730211382661171> | Successfully Setuped `Girl Mod` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def rsta(self, context: Context) -> None:
    if data := getConfig(context.guild.id):
      ...
      embed = discord.Embed(
        ...
        color=0x00FFCA)
      embed.add_field(name="<:tick_icons:1124596979813580801> Staff Role:",
                      value=f"{staffr}",
                      inline=False)
      embed.add_field(name="<:tick_icons:1124596979813580801> Girl Role:",
                      value=f"{girlr}",
                      inline=False)
      embed.add_field(name="<:tick_icons:1124596979813580801> Vip Role:",
                      value=f"{vipr}",
                      inline=False)
      embed.add_field(name="<:tick_icons:1124596979813580801> Guest Role:",
                      value=f"{guestr}",
                      inline=False)
      embed.add_field(name="<:tick_icons:1124596979813580801> Friend Role:",
                      value=f"{frndr}",
                      inline=False)
      embed.add_field(name="<:tick_icons:1124596979813580801> Owner Role:",
                      value=f"{own}",
                      inline=False)
      embed.add_field(name="<:tick_icons:1124596979813580801> Co Owner Role:",
                      value=f"{coown}",
                      inline=False)
      embed.add_field(
        name="<:tick_icons:1124596979813580801> Head Admin Role:",
        value=f"{headmin}",
        inline=False)
      embed.add_field(name="<:tick_icons:1124596979813580801> Admin Role:",
                      value=f"{adminss}",
                      inline=False)
      embed.add_field(
        name="<:tick_icons:1124596979813580801> Girl Admin Role:",
        value=f"{gadminss}",
        inline=False)
      embed.add_field(name="<:tick_icons:1124596979813580801> Head Mod Role:",
                      value=f"{hmod}",
                      inline=False)
      embed.add_field(name="<:tick_icons:1124596979813580801> Mod Role:",
                      value=f"{mod}",
                      inline=False)
      embed.add_field(name="<:tick_icons:1124596979813580801> Girl Mod Role:",
                      value=f"{gmod}",
                      inline=False)
  ...
  async def rstaff(self, context: Context, member: discord.Member) -> None:
    if data := getConfig(context.guild.id):
      ...
      hacker = discord.Embed(
        description=
        f"<a:tickkk:1130730211382661171> | Successfully Removed <@&{role}> From {member.mention}",
        color=0x00FFCA)
      hacker.set_author(name=f"{context.author}",
                        icon_url=f"{context.author.avatar}")
      hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def _create(self, ctx, name, *, message):
    with open("data/json/autoresponse.json", "r", encoding="utf-8") as f:
    ...
    if str(ctx.guild.id) in autoresponse:
      ...
      if len(numbers) >= 20:
        hacker6 = discord.Embed(
          title="Redox",
          description=
          f"<a:crossss:1131829269509709875>  You can\'t add more than 20 autoresponses in {ctx.guild.name}",
          color=0x00FFCA)
    ...
    if str(ctx.guild.id) in autoresponse:
      if name in autoresponse[str(ctx.guild.id)]:
        hacker = discord.Embed(
          title="Redox",
          description=
          f"<:icons_cross:1124690918893690920>  The autoresponse with the `{name}` is already in {ctx.guild.name}",
          color=0x00FFCA)
    ...
    if str(ctx.guild.id) in autoresponse:
      ...
      with open("data/json/autoresponse.json", "w", encoding="utf-8") as f:
        json.dump(autoresponse, f, indent=4)
      hacker1 = discord.Embed(
        title="Redox",
        description=
        f"<a:tickkk:1130730211382661171>  | Successfully Created Autoresponder in {ctx.guild.name} with the `{name}`",
        color=0x00FFCA)
    ...
    with open("data/json/autoresponse.json", "w", encoding="utf-8") as f:
      ...
      hacker2 = discord.Embed(
        ...
        f"<a:tickkk:1130730211382661171>  | Successfully Created Autoresponder  in {ctx.guild.name} with the `{name}`",
        color=0x00FFCA)
      hacker2.set_author(name=f"{ctx.author}", icon_url=f"{ctx.author.avatar}")
    ...
    if str(ctx.guild.id) in autoresponse:
      if name in autoresponse[str(ctx.guild.id)]:
        ...
        hacker1 = discord.Embed(
          title="Redox",
          description=
          f"<a:tickkk:1130730211382661171> | Successfully Deleted Autoresponder in {ctx.guild.name} with the `{name}`",
          color=0x00FFCA)
        ...
        hacker = discord.Embed(
          title="Redox",
          description=
          f"<a:crossss:1131829269509709875>  No Autoresponder Found With The Name `{name}` In {ctx.guild.name}",
          color=0x00FFCA)
        hacker.set_author(name=f"{ctx.author}",
                          icon_url=f"{ctx.author.avatar}")
        hacker.set_thumbnail(url=f"{ctx.author.avatar}")
      ...
      hacker2 = discord.Embed(
        title="Redox",
        description=
        f"<a:crossss:1131829269509709875>  There is no Autoresponder in {ctx.guild.name}",
        color=0x00FFCA)
      hacker2.set_author(name=f"{ctx.author}", icon_url=f"{ctx.author.avatar}")
      hacker2.set_thumbnail(url=f"{ctx.author.avatar}")
      return await ctx.reply(embed=hacker2)
    ...
    if str(ctx.guild.id) in autoresponse:
      if name in autoresponse[str(ctx.guild.id)]:
        ...
        hacker1 = discord.Embed(
          title="Redox",
          description=
          f"<a:tickkk:1130730211382661171>  | Successfully Edited Autoresponder in {ctx.guild.name} with the `{name}`",
          color=0x00FFCA)
        hacker1.set_author(name=f"{ctx.author}",
                           icon_url=f"{ctx.author.avatar}")
        hacker1.set_thumbnail(url=f"{ctx.author.avatar}")
