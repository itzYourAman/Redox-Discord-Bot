...
class autosnipe(commands.Cog):
    def __init__(self, bot):
        self.bot = bot
        self.connection = mongodb.AsyncIOMotorClient("mongodb+srv://amangamer37369:amanop@cluster01.axf5snb.mongodb.net/?retryWrites=true&w=majorit")
        self.db = self.connection["Redox"]["servers"]
    ...
    async def channel(self, ctx, c: discord.TextChannel):
        try:
            ...
            await ctx.send(f"<a:tickkk:1130730211382661171>  | autosnipe channel are updated to <#{c.id}>")
    ...
    async def delete(self, ctx: commands.Context):
        ...
        await ctx.send(f'<a:tickkk:1130730211382661171> | Successfully Deleted autosnipe Channel')
