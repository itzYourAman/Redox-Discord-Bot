...
async def do_removal(ctx, limit, predicate, *, before=None, after=None):
    ...
    deleted = len(deleted)
    messages = [f'<a:tickkk:1130730211382661171> | {deleted} message{" was" if deleted == 1 else "s were"} removed.']
    if deleted:
        messages.append("")
    ...
    if len(to_send) > 2000:
        await ctx.send(f"<a:tickkk:1130730211382661171> | Successfully removed {deleted} messages.", delete_after=10)
    else:
...
class mod(commands.Cog):
      ...
      if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
          if len(wled) == 100:
              hacker = discord.Embed(
                   ...
                   description=
                       "<a:right_arrow:1134883730499063909> You are trying to add more users than what it's allowed in [Trusted Mods]!",
                    color=self.color)
              ...
              if str(user.id) in wled:
                  ...
                  hacker1.add_field(
                    name="<a:tickkk:1130730211382661171> Successful Operations",
                        value="No successful operation!",
                     inline=False)
                  hacker1.add_field(
                    name="<a:crossss:1131829269509709875> Unsuccessful Operations",
                     value=
                      f"""<a:right_arrow:1134883730499063909> `{user}` <a:crossss:1131829269509709875>
                                                                <a:right_arrow:1134883730499063909> *Already exists!*""",
                      inline=False)
                  hacker1.set_author(
                  ...
                  hacker4.add_field(
                        name="<a:tickkk:1130730211382661171> Successful Operations",
                           value=f"<a:right_arrow:1134883730499063909> `{user}`",
                              inline=False)
                  hacker4.add_field(
                              name="<a:crossss:1131829269509709875> Unsuccessful Operations",
          ...
          if str(user.id) in wled:
              ...
              hacker1.add_field(
                    name="<a:crossss:1131829269509709875> Unsuccessful Operations",
                     value=
                      f"""<a:right_arrow:1134883730499063909> `{user}` <a:crossss:1131829269509709875>
                                                                <a:right_arrow:1134883730499063909> *Already not exists!*""",
                      inline=False)
              hacker1.set_author(
                    name="Gban Removal Result:",
                    icon_url=ctx.author.avatar.url if ctx.author.avatar else ctx.author.default_avatar.url)
  ...
  async def mod_show(self, ctx):   
        ...
        if len(wled) == 0:
           ...
           title=self.bot.user.name,
        description=
        f"<a:crossss:1131829269509709875> | There aren\'t any Gban users for this server"
      )
            await ctx.reply(embed=hacker, mention_author=False)
        else:
            entries = [
  ...
  async def mod_reset(self, ctx):
        ...
        title=self.bot.user.name,
        description=
        f"<a:tickkk:1130730211382661171> | Successfully Cleared Gban Database For **{ctx.guild.name}**"
      )
            await ctx.reply(embed=hacker, mention_author=False)
        else:
            hacker5 = discord.Embed(
  ...
  async def mod_role(self, ctx,  *,role: discord.Role):
        ...
        title=self.bot.user.name,
        description=
        f"<a:tickkk:1130730211382661171> | {role.mention} Has Been Added To Gban Role For {ctx.guild.name}"
      )
            await ctx.reply(embed=hacker4, mention_author=False)
        else:
            hacker5 = discord.Embed(
  ...
  async def roleicon(self, ctx: commands.Context, role: discord.Role, *, icon: Union[discord.Emoji, discord.PartialEmoji, str]=None):
        ...
        if icon is None:
            ...
            if c:
                try:
                    ...
                    em = discord.Embed(description=f"<a:tickkk:1130730211382661171> | Successfully changed icon of {role.mention}", color=self.color)
                except:
                    return await ctx.reply("Failed to change the icon of the role")
            else:
                await role.edit(display_icon=None)
                em = discord.Embed(description=f"<a:tickkk:1130730211382661171> | Successfully removed icon from {role.mention}", color=self.color)
        ...
        if isinstance(icon, discord.Emoji) or isinstance(icon, discord.PartialEmoji):
            ...
            try:
              ...
              return await ctx.reply("Failed to change the icon of the role")
            await role.edit(display_icon=img)
            em = discord.Embed(description=f"<a:tickkk:1130730211382661171> | Successfully changed the icon for {role.mention} to {icon}", color=self.color)
            return await ctx.reply(embed=em, mention_author=False)
        else:
            ...
            await role.edit(display_icon=img)
            em = discord.Embed(description=f"<a:tickkk:1130730211382661171> | Successfully changed the icon for {role.mention}", color=self.color)
            return await ctx.reply(embed=em, mention_author=False)
      ...
      if role not in member.roles:
        try:
          hacker1 = discord.Embed(
            description=
            f"<a:tickkk:1130730211382661171> | Changed roles for {member.name}, Added {role.name}",
            color=self.color)
        ...
        try:
          hacker = discord.Embed(
            description=
            f"<a:tickkk:1130730211382661171> | Changed roles for {member.name}, Removed {role.name}",
            color=self.color)
  ...
  async def temp(self, ctx, role: discord.Role, time, *, user: discord.Member):
    ...
    if role == ctx.author.top_role:
      embed = discord.Embed(
        description=
        f"<a:crossss:1131829269509709875> | {role} has the same position as your top role!",
        color=self.color)
      ...
      if role.position >= ctx.guild.me.top_role.position:
        embed1 = discord.Embed(
          description=
          f"<a:crossss:1131829269509709875> | {role} is higher than my role, move my role above {role}.",
          color=self.color)
    ...
    hacker = discord.Embed(
      description=
      f"<a:tickkk:1130730211382661171> | Successfully added {role.mention} to {user.mention} .",
      color=self.color)
    await ctx.send(embed=hacker)
  ...
  async def delete(self, ctx,*, role: discord.Role):
    ...
    if role is None:
      embed2 = discord.Embed(
        description=
        f"<a:crossss:1131829269509709875> | No role named {role} found in this server .",
        color=self.color)
      return await ctx.send(embed=embed2)
    await role.delete()
    hacker = discord.Embed(
      description=
      f"<a:tickkk:1130730211382661171> | Successfully deleted {role}",
      color=self.color)
    await ctx.send(embed=hacker)
  ...
  async def create(self, ctx, *, name):
    ...
    if ctx.author == ctx.guild.owner or ctx.guild.me.top_role <= ctx.author.top_role:
      hacker = discord.Embed(
        description=
        f"<a:tickkk:1130730211382661171> | Successfully created role with the name {name}",
        color=self.color)
  ...
  async def rename(self, ctx, role: discord.Role, *, newname):
    ...
    if ctx.author == ctx.guild.owner or ctx.guild.me.top_role <= ctx.author.top_role:
      ...
      await ctx.send(
        f"<a:tickkk:1130730211382661171> | Role {role.name} has been renamed to {newname}"
      )
    elif role is None:
      embed2 = discord.Embed(
        description=
            ...
            if interaction.user == ctx.author:
                if interaction.guild.me.guild_permissions.ban_members:
                    ...
                    await interaction.channel.send(
                           content=f"<a:tickkk:1130730211382661171> | Successfully Added {role.mention} To {a} Human(s) .")
                else:
                    await interaction.response.edit_message(
                        content=
        ...
        async def button_callback(interaction: discord.Interaction):
            ...
            if interaction.user == ctx.author:
                if interaction.guild.me.guild_permissions.ban_members:
                    ...
                    await interaction.channel.send(
            content=f"<a:tickkk:1130730211382661171> | Successfully Added {role.mention} To {a} Bot(s) .")
                else:
                    await interaction.response.edit_message(
                         content=
                           "I am missing permission.\ntry giving me permissions and retry",
        ...
        async def button_callback(interaction: discord.Interaction):
            ...
            if interaction.user == ctx.author:
                if interaction.guild.me.guild_permissions.ban_members:
                  ...
                  await interaction.channel.send(
            content=f"<a:tickkk:1130730211382661171> | Successfully Added {role.mention} To {a} Unverified Member(s) .")
                else:
                    await interaction.response.edit_message(
                         content=
                           "I am missing permission.\ntry giving me permissions and retry",
        ...
        async def button_callback(interaction: discord.Interaction):
            ...
            if interaction.user == ctx.author:
                if interaction.guild.me.guild_permissions.ban_members:
                  ...
                  await interaction.channel.send(
            content=f"<a:tickkk:1130730211382661171> | Successfully Added {role.mention} To {a} Member(s) .")
                else:
                    await interaction.response.edit_message(
                         content=
                           "I am missing permission.\ntry giving me permissions and retry",
 ...
 # @ignore_check()
  ...
  async def _mute(self, ctx, member: discord.Member, duration):
        ...
        if tame == -1:
            hacker3 = discord.Embed(
                color=0x2f3136,
                description=
                f"<a:crossss:1131829269509709875> | You didnt didnt gave time with correct unit\nExamples:\n{ctx.prefix}mute {ctx.author} 10m\n{ctx.prefix}mute {ctx.author} 5hr",
            ...
            hacker4 = discord.Embed(
                color=0x2f3136,
                description=
                f"<a:crossss:1131829269509709875> | Time must be an integer!",
                timestamp=ctx.message.created_at)
            await ctx.reply(embed=hacker4, mention_author=False)
        else:
            if till.lower() == "d":
                ...
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    " <a:tickkk:1130730211382661171> | Successfully Muted {0.mention} For {1} Day(s)"
                    .format(member, ok),
                    timestamp=ctx.message.created_at)
            elif till.lower() == "m":
                t = datetime.timedelta(seconds=tame)
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    " <a:tickkk:1130730211382661171> | Successfully Muted {0.mention} For {1} Minute(s)"
                    .format(member, ok),
                    timestamp=ctx.message.created_at)
            elif till.lower() == "s":
                t = datetime.timedelta(seconds=tame)
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    " <a:tickkk:1130730211382661171> | Successfully Muted {0.mention} For {1} Second(s)"
                    .format(member, ok),
                    timestamp=ctx.message.created_at)
            elif till.lower() == "h":
                t = datetime.timedelta(seconds=tame)
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    "<a:tickkk:1130730211382661171> | Successfully Muted {0.mention} For {1} Hour(s)"
                    .format(member, ok),
                    timestamp=ctx.message.created_at)
        try:
            if member.guild_permissions.administrator:
                hacker1 = discord.Embed(
                    color=0x2f3136,
                    description=
                    "<a:crossss:1131829269509709875> | I can\'t mute administrators",
                    timestamp=ctx.message.created_at)
  ...
  async def _reactions(self, ctx, search=100):
        ...
        await ctx.success(f"<a:tickkk:1130730211382661171> | Successfully removed {total_reactions} reactions.")
  ...
  async def _prefix(self, ctx: commands.Context, prefix):
    ...
    if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
      ...
      await ctx.reply(embed=discord.Embed(
        description=
        f"<a:tickkk:1130730211382661171> | Successfully Changed Prefix For **{ctx.guild.name}**\nNew Prefix for **{ctx.guild.name}** is : `{prefix}`\nUse `{prefix}help` For More info .",
        color=self.color))
    else:
      hacker5 = discord.Embed(
        description=
