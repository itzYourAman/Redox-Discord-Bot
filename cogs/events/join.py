...
class Join(commands.Cog):
    ...
    async def on_guild_join(self, guild):
         ...
         # data['backupkey'] = key
          ...
          skidgod = Button(label='Support Server', style=discord.ButtonStyle.link, url='https://discord.com/invite/CCYef4Ad4M')
          #web = Button(label='Website', style=discord.ButtonStyle.link, url='https://discord.gg/3YmDAzbuRR')
          docs = Button(label='Invite Me',style=discord.ButtonStyle.link,url='https://discord.com/api/oauth2/authorize?client_id=1126351590064930847&permissions=8&scope=bot%20applications.commands')

          docs1 = Button(label='Vote Me',style=discord.ButtonStyle.link,url='https://discord.com/invite/CCYef4Ad4M')
       ...
       # vote = Button(label='Vote Me', style=discord.ButtonStyle.link, url='https://discord.com/oauth2/authorize?client_id=1021416292185546854&permissions=2113268958&scope=bot')
         ...
         # view.add_item(b)
          ...
          embed.set_thumbnail(url=guild.me.display_avatar.url if guild.owner.avatar is None else guild.owner.avatar.url)
